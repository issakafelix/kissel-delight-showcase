...
export const DEFAULT_MENU: Omit<MenuItem, "id">[] = [
  ...
  },
  {
    ...
    price: 1000,
    category: "drinks",
    image: "https://loremflickr.com/800/600/fanta,soda?lock=71",
    available: true,
    sortOrder: 13,
  },
  {
    ...
    price: 1000,
    category: "drinks",
    image: "https://loremflickr.com/800/600/sprite,soda?lock=72",
    available: true,
    sortOrder: 14,
  },
  {
    ...
    price: 1500,
    category: "drinks",
    image: "https://loremflickr.com/800/600/malt,drink?lock=73",
    available: true,
    sortOrder: 15,
  },
  {
